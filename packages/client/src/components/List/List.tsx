...
const List = ({
  ...
  onDragEnd: (data: any) => void; // Add event handlers for drag and drop events in your component's parent component.  // For example, in your parent component: onDragStart={handleDragStart} onDragEnd={handleDragEnd}
}) => {
  const titleRef = useRef(null);
  const initialDraggedData = useAppSelector(
